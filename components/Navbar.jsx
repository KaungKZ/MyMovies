  ...
  return (
    <div className="navbar h-28 shadow-emerald bg-lightGray">
      <div className="navbar__content flex w-4/5 justify-between items-center m-auto h-full">
        ...
        <div className="navbar__right-items flex w-8/12 justify-end items-center">
          <div className="navbar__search-bar min-w-300 relative mr-5">
            <SearchIcon className="h-5 w-5 text-gray-400 pointer-events-none absolute top-1/2 transform -translate-y-1/2 left-3" />
            <input
              type="text"
              className="focus:outline-none focus:ring-green-300 focus:ring-2 focus:border-transparent px-4 pl-10 py-2 bg-green-50 transition rounded text-sm w-full shadow-sm"
              placeholder="Search Anything .."
            />
          </div>
          <nav className="navbar__nav flex text-gray-500 ">
            <a
              className="navbar__link mr-4 hover:text-gray-600 transition font-medium"
              href="#"
            >
              Trending
            </a>
            ...
            <a
              className="navbar__link hover:text-gray-600 transition font-medium"
              href="#"
            >
              Top Rated
            </a>
