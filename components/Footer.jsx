  ...
  return (
    <div className="footer w-full h-20 flex justify-center items-center mt-32 xl:mt-28 lg:mt-20 sm:mt-16 relative xsm:mt-10">
      <div className="footer__wrapper w-full">
        ...
        <div className="footer__content font-bold flex justify-center items-center w-full h-20 bg-green-200 md:h-16 xsm:h-14">
          <span className="icon mr-1 text-green-500 mb-4 xsm:mb-2">
